...
* March 2023: The first data challenge can be found [here](https://github.com/cositools/cosi-data-challenge-1.git).
* March 2024: The second data challenge can be found [here](https://github.com/cositools/cosi-data-challenge-2).
* April 2025: The third data challenge can be found [here](https://github.com/cositools/cosi-data-challenges).
